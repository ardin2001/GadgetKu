...
{
    public partial class pengeluaran_form : Form
    {
        CRUD_pengeluaran crud = new CRUD_pengeluaran();
        public pengeluaran_form()
        {
            InitializeComponent();
            READ();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                if (dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
                {
                    ...
                    u_jumlah.Text = (dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString());
                    u_harga.Text = (dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString());
                }
            }
            catch
            {
        ...
        private void pengeluaran_form_Load(object sender, EventArgs e)
        {
